		...
		stage('Checkout Source code and Logging Into Registry') {
			steps {
				...
				script {
					...
					ACCOUT_REGISTRY_PREFIX = "480593292995.dkr.ecr.us-east-2.amazonaws.com/"
					sh """
	...
	stages {
		stage('Make A Builder Image') {
			steps {
				...
				script {
					builderImage = docker.build("${ACCOUT_REGISTRY_PREFIX}/example-webapp-builder:${GIT_COMMIT_HASH}", "-f ./Dockerfile.builder .")
